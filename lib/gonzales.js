...
/***/ (function(module, exports, __webpack_require__) {
	...
	function parser(css, options) {
	  if (typeof css !== 'string') throw new Error('Please, pass a string to parse');else if (!css) return __webpack_require__(17)();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function checkVariable(i) {
	  ...
	  if (l = checkVariableName(i)) i += l;else return 0;
